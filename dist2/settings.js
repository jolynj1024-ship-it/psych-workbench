...
window.SettingsPage = function SettingsPage({
  ...
  const [importFile, setImportFile] = stUseState(null);
  stUseEffect(() => {
    setWt(workTypes || {});
  }, [workTypes]);
  stUseEffect(() => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "font-bold text-gray-800 mb-1"
  }, "\u2601\uFE0F \u6570\u636E\u540C\u6B65"), /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-gray-400 mb-4"
  }, "\u5BFC\u51FA\u5168\u90E8\u6570\u636E\u4E3A JSON \u6587\u4EF6\uFF0C\u5728\u53E6\u4E00\u53F0\u8BBE\u5907\u4E0A\u5BFC\u5165\u5373\u53EF\u540C\u6B65\u3002\u9002\u7528\u4E8E\u624B\u673A\u4E0E\u7535\u8111\u4E0D\u5728\u540C\u4E00\u7F51\u7EDC\u65F6\u7684\u8FDC\u7A0B\u540C\u6B65\u3002"), /*#__PURE__*/React.createElement("div", {
    className: "flex flex-wrap gap-3"
  }, /*#__PURE__*/React.createElement(Btn, {
    onClick: () => window.exportData()
  }, "\uD83D\uDCE4 \u5BFC\u51FA\u5168\u90E8\u6570\u636E"), /*#__PURE__*/React.createElement("label", {
  ...
  }, "\uD83D\uDCE5 \u5BFC\u5165\u6570\u636E\u6587\u4EF6", /*#__PURE__*/React.createElement("input", {
    type: "file",
    accept: ".json",
    className: "hidden",
    onChange: e => {
  ...
  })), importFile && /*#__PURE__*/React.createElement("span", {
    className: "text-xs text-gray-400 self-center"
  }, "\u5DF2\u9009\uFF1A", importFile))), /*#__PURE__*/React.createElement(Modal, {
    open: confirmArch,
    title: "\u26A0\uFE0F \u5F52\u6863\u786E\u8BA4",
